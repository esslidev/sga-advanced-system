...
exports.ErrorMessage = exports.ErrorTitle = exports.ErrorHttpStatusCode = void 0;
exports.ErrorHttpStatusCode = {
    BAD_REQUEST: 400,
    UNAUTHORIZED: 401,
    FORBIDDEN: 403,
    NOT_FOUND: 404,
...
exports.ErrorMessage = {
    ...
    TOKEN_EXPIRED: "انتهت صلاحية الرمز المقدم. يرجى الحصول على رمز جديد لمتابعة الوصول.",
    INVALID_SIGNUP_DATA: "بيانات التسجيل غير صحيحة. يرجى تقديم معلومات صحيحة للتسجيل.",
    INVALID_SIGNIN_DATA: "بيانات تسجيل الدخول غير صحيحة. يرجى تقديم معلومات صحيحة للدخول.",
    NOT_FOUND: "المورد المطلوب غير موجود على الخادم.",
    FORBIDDEN: "ليس لديك الصلاحيات اللازمة للوصول إلى هذا المورد.",
    USER_ALREADY_EXISTS: "مستخدم بهذا البريد الإلكتروني أو معرف طرف ثالث موجود مسبقًا.",
    ...
    INVALID_PASSWORD: "تم تقديم كلمة مرور غير صحيحة. يجب أن تكون كلمة المرور مكونة من 8 أحرف على الأقل وتحتوي على أحرف وأرقام.",
    INTERNAL_SERVER_ERROR: "حدث خطأ غير متوقع في الخادم. يرجى المحاولة لاحقًا أو التواصل مع الدعم للمساعدة.",
    // Visitor-related
