...
const ErrorMessage = {
    ...
    VISITOR_ALREADY_EXISTS: "Visitor with the provided information already exists in the system.",
    VISITOR_DELETED: "The visitor has been successfully deleted from the system.",
    VISITOR_DELETED_PREVIOUSLY: "This visitor was previously deleted. Please contact support for further assistance.",
    //ErrorMessage Visit
    VISIT_NOT_FOUND: "The requested visit could not be found. Please verify the visit ID.",
    INVALID_VISIT_DATA: "Invalid visit data provided. Please check the input and try again.",
};
